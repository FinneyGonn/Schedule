...
.notif-card.unread { background: rgba(200,169,110,.04) }
...
.notif-icon.Sistema  { background: rgba(100,160,220,.15); color: #64a0dc }
.notif-icon.Urgente  { background: rgba(224,112,112,.15); color: var(--danger) }
.notif-icon.Aviso    { background: rgba(200,169,110,.15); color: var(--accent) }
...
.notif-badge.Sistema { background: rgba(100,160,220,.15); color: #64a0dc }
.notif-badge.Urgente { background: rgba(224,112,112,.15); color: var(--danger) }
.notif-badge.Aviso   { background: rgba(200,169,110,.15); color: var(--accent) }
